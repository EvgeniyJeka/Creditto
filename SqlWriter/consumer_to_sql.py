...
class ConsumerToSql(object):
    ...
    def start_consumer(self):
        ...
        admin_client = KafkaAdminClient(bootstrap_servers=Config.kafka_bootstrap_servers.value, client_id='test')
        ...
        # Initiating consumer
        self.consumer = KafkaConsumer('offers', 'bids', 'matches', bootstrap_servers=[Config.kafka_bootstrap_servers.value],
