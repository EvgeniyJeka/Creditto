...
class TestMatcherRecovery:
    """
        ...
        1. End-to-End flow can be successfully performed after Matcher docker container was restarted
        2. Matcher container is expected to resume it's functionality and
    ...
    @pytest.mark.parametrize('restart_container', [[DockerContainerNames.MATCHER.value]], indirect=True)
    def test_placing_offer(self, set_matching_logic, restart_container, get_authorized_borrowers):
        ...
        response = postman.gateway_requests.place_offer(TestMatcherRecovery.borrower.user_id, test_sum,
                                                        ...
                                                        TestMatcherRecovery.borrower.jwt_token)
