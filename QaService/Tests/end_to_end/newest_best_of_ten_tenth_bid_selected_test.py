...
class TestBestOfTen:
    """
        This test comes to verify, that providing the matching logic 'Newest Best Of Ten" is selected
        the tenth bid will match with the offer if it has the lowest interest (and no match will happen
        until the 10 bids will be placed).
        Steps:
        1. Placing the offer
        ...
        7. Verifying match data - the offer is expected to match with the 10th bid
    ...
    def test_placing_final_bids(self):
        try:
            ...
            for i in range(5, 10):
                ...
                # The 10th bid is expected to match in this test.
                if i == 9:
    ...
    def test_updated_offer_after_match(self):
        try:
            ...
            assert offer_sql['final_interest'] == str(test_bid_interest_10), \
    ...
    def test_match_data_verified(self):
        try:
            ...
            assert match_sql['bid_owner_id'] == TestBestOfTen.lenders[9].user_id
            assert match_sql['final_interest'] == str(test_bid_interest_10)
